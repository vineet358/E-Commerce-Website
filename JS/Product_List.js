const products = [
     // T-Shirts
     { id: 1, name: 'Classic White Cotton Tee', price: 499, category: 'T-Shirts', image: '' },
     { id: 2, name: 'Graphic Printed Tee', price: 699, category: 'T-Shirts', image: '' },
     { id: 3, name: 'Oversized Retro Tee', price: 799, category: 'T-Shirts', image: '' },
     { id: 4, name: 'Color Block Tee', price: 649, category: 'T-Shirts', image: '' },
     { id: 5, name: 'Tie-Dye Tee', price: 899, category: 'T-Shirts', image: '' },
     { id: 6, name: 'Striped Casual Tee', price: 599, category: 'T-Shirts', image: '' },
     { id: 7, name: 'Slim Fit Crew Neck Tee', price: 749, category: 'T-Shirts', image: '' },
     { id: 8, name: 'V-Neck Summer Tee', price: 549, category: 'T-Shirts', image: '' },
     { id: 9, name: 'Pocketed Basic Tee', price: 499, category: 'T-Shirts', image: '' },
     { id: 10, name: 'Longline Urban Tee', price: 799, category: 'T-Shirts', image: '' },

     // Shirts
     { id: 11, name: 'Slim Fit Formal Shirt', price: 999, category: 'Shirts', image: '' },
     { id: 12, name: 'Floral Print Casual Shirt', price: 849, category: 'Shirts', image: '' },
     { id: 13, name: 'Plaid Checkered Shirt', price: 749, category: 'Shirts', image: '' },
     { id: 14, name: 'Denim Button-Up Shirt', price: 1299, category: 'Shirts', image: '' },
     { id: 15, name: 'Mandarin Collar Shirt', price: 899, category: 'Shirts', image: '' },
     { id: 16, name: 'Short Sleeve Cuban Shirt', price: 799, category: 'Shirts', image: '' },
     { id: 17, name: 'Linen Summer Shirt', price: 1199, category: 'Shirts', image: '' },
     { id: 18, name: 'Satin Partywear Shirt', price: 1599, category: 'Shirts', image: '' },
     { id: 19, name: 'Pinstriped Office Shirt', price: 1049, category: 'Shirts', image: '' },
     { id: 20, name: 'Ombre Dyed Shirt', price: 1099, category: 'Shirts', image: '' },
     ...
     // Swimwear
     { id: 121, name: 'High-Waisted Bikini Set', price: 1499, category: 'Swimwear', image: '' },
     { id: 122, name: 'One-Shoulder Swimsuit', price: 1999, category: 'Swimwear', image: '' },
     { id: 123, name: 'Mesh Panel Monokini', price: 1799, category: 'Swimwear', image: '' },
     { id: 124, name: 'Board Shorts', price: 999, category: 'Swimwear', image: '' },
     { id: 125, name: 'Tankini Top and Bottom', price: 1599, category: 'Swimwear', image: '' },
     { id: 126, name: 'Crochet Beach Cover-Up', price: 1299, category: 'Swimwear', image: '' },
     { id: 127, name: 'Racerback Swim Dress', price: 1899, category: 'Swimwear', image: '' },
     { id: 128, name: 'Cut-Out Swimsuit', price: 1699, category: 'Swimwear', image: '' },
     { id: 129, name: 'Swim Trunks', price: 899, category: 'Swimwear', image: '' },
     { id: 130, name: 'Bandeau Bikini Top', price: 1199, category: 'Swimwear', image: '' },
     
     // Dresses
     { id: 61, name: 'Floral Maxi Dress', price: 1799, category: 'Dresses', image: '' },
     { id: 62, name: 'Satin Slip Dress', price: 1999, category: 'Dresses', image: '' },
     { id: 63, name: 'Off-Shoulder Cocktail Dress', price: 2499, category: 'Dresses', image: '' },
     { id: 64, name: 'Bodycon Evening Dress', price: 2299, category: 'Dresses', image: '' },
     { id: 65, name: 'Puff-Sleeve Mini Dress', price: 1599, category: 'Dresses', image: '' },
     { id: 66, name: 'Wrap Tie-Waist Dress', price: 1899, category: 'Dresses', image: '' },
     { id: 67, name: 'Lace A-Line Dress', price: 2599, category: 'Dresses', image: '' },
     { id: 68, name: 'Denim Shirt Dress', price: 1799, category: 'Dresses', image: '' },
     { id: 69, name: 'Pleated Midi Dress', price: 2099, category: 'Dresses', image: '' },
     { id: 70, name: 'Boho Style Tiered Dress', price: 1699, category: 'Dresses', image: '' },
     { id: 183, name: 'Neckline Ruched Midi Dress', price: 1999, category:'Dresses', image:'https://dtdz5ym1pqo86.cloudfront.net/sites/files/mikayla/images/products/202401/dsc00187-enhanced-nr.jpg'},
     ...
     { id: 184, name: 'Floral Print Pleated Skirt', price: 1199, category:'Skirts', image:'https://i.pinimg.com/736x/68/b2/23/68b223e26606cf38fe337cce41caca5c--floral-print-skirt-floral-skirts.jpg'}
];
